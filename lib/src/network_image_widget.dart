...
class NetworkImageWidget extends StatelessWidget {
  ...
  const NetworkImageWidget(
      ...
      this.height,
      this.boxFit,
      this.borderRadius, this.isClickFullScreen})
      : super(key: key);
        ...
        showModalBottomSheet(
            ...
            builder: (context) {
              return FractionallySizedBox(
                heightFactor: 1,
                child: FullScreenImage(imageUrl: url.toString()=="null"?"https://images.assetsdelivery.com/compings_v2/yehorlisnyi/yehorlisnyi2104/yehorlisnyi210400016.jpg":url),
              );
            });
      }:null,
